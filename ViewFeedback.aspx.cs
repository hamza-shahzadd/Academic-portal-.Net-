...
public partial class ViewFeedback : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query = "select Feedback.feedback_score,Feedback.feedbackText from Feedback where Feedback.LinstructorId = @id or Feedback.CinstructorId=@id"; // Use parameterized query
