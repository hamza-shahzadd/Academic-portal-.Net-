...
public partial class RegisteredCourses : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query = " select StudentcourseAlloc.courseId, courses.courseName from StudentcourseAlloc join courses on StudentcourseAlloc.courseId=courses.courseId where StudentcourseAlloc.rollnumber=@id";
