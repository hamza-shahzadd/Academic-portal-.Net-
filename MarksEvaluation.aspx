<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MarksEvaluation.aspx.cs" Inherits="MarksEvaluation" %>
...
<body>
	...
	<h1>Marks Evaluation</h1>
    <form id="form1" runat="server">
        <div class="form-group">
    <label for="attendance_id">Evaluation ID:</label>
    <input type="text" id="evalattendance_id" name="evalattendance_id">
</div>
<div class="form-group">
