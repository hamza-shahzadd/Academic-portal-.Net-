...
public partial class Transcript : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query = " select Transcript.courseId,Transcript.courseName,Transcript.credits,Transcript.semester,Transcript.Cgpa,Transcript.Sgpa from Transcript where Transcript.rollnumber  = @id"; // Use parameterized query
